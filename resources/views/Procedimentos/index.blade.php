    ...
    <table class="table table-bordered table-responsive">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="#edit{{$procedimento->pk_cod_proc}}" data-bs-toggle="modal" class="btn btn-success">Editar</a></td>
                <td>
                    <form action="{{ route('procedimentos.destroy', ['pk_cod_proc' => $procedimento->pk_cod_proc]) }}" method="post">
                        @csrf
                        @method('DELETE')
