            ...
            <form class="row g-3" method="POST" action="{{ route('configuracoes.store') }}">
              ...
              <div>
                <div class="col-md-3">
                  ...
                  <input type="number" class="form-control" id="cep_clin" name="cep_clin" value="{{ old('cep_clin', $clinica->cep_clin) }}">
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-2">
                  ...
                  <input type="number" class="form-control" id="numero_clin" name="numero_clin" value="{{ old('numero_clin', $clinica->numero_clin) }}">
                </div>
                <div class="col-md-4">
                    <label for="inputCBairro" class="form-label">BAIRRO</label>
                    <input type="text" class="form-control" id="bairro_clin" name="bairro_clin" value="{{ old('bairro_clin', $clinica->bairro_clin) }}">
                </div>
                <div class="col-md-4">
                    <label for="inputComplemento" class="form-label">COMPLEMENTO</label>
                    <input type="text" class="form-control" id="complemento_clin" name="complemento_clin" value="{{ old('complemento_clin', $clinica->complemento_clin) }}">
                </div>
                <div class="col-md-4">
                    <label for="inputCidade" class="form-label">CIDADE</label>
                    <input type="text" class="form-control" id="cidade_clin" name="cidade_clin" value="{{ old('cidade_clin', $clinica->cidade_clin) }}">
                </div>
                <div class="col-md-2">
                    <label for="inputUF" class="form-label">UF (ESTADO)</label>
                    <input type="text" class="form-control" id="uf_clin" name="uf_clin" value="{{ old('uf_clin', $clinica->uf_clin) }}">
                </div>
                <div class="col-md-2">
                    <label for="inputCodIBGE" class="form-label">CÓD. IBGE</label>
                    <input type="number" class="form-control" id="cod_ibge_clin" name="cod_ibge_clin" value="{{ old('cod_ibge_clin', $clinica->cod_ibge_clin) }}">
                </div>
              <div class="col-12">
