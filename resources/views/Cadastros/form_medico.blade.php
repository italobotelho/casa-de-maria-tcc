        ...
        <div class="container">
            ...
            <form action="{{ route('medico.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nome_med" name="nome_med"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="telefone_med" name="telefone_med"
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email_med" name="email_med"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="uf_med" name="uf_med"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="especialidade1_med" name="especialidade1_med" value="{{ old('especialidade1_med') }}"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="especialidade2_med" id="especialidade2_med"
                        value="{{ old('especialidade2_med') }}" required>
                </div>

                <div>
                    <label for="pk_crm_med">CRM:</label>
                    <input type="text" name="pk_crm_med" id="pk_crm_med"
