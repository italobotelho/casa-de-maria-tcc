            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-8">
                    <div class="card shadow">
                        <div class="card-header bg-success text-white d-flex justify-content-between"></div>
                                ...
                                <tbody>
                                    @forelse($pacientes as $paciente)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="col nome-paciente" href="#" 
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center fs-4">Nenhum paciente cadastrado</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('paciente.update') }}" id="formEditarPaciente">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="editar-data-nascimento">Data de Nascimento</label>
                            <input type="date" class="form-control" id="editar-data-nascimento" name="data_nascimento" required>
                        </div>
                        <div class="form-group">
                            <label for="editar-convenio-id">Convênio</label>
                            <input type="text" maxlength="14" class="form-control" id="editar-convenio-id" name="convenio_id" required>
                        </div>
                        <div class="form-group">
                            <label for="editar-telefone">Telefone</label>
                            <input type="text" maxlength="11" class="form-control" id="editar-telefone" name="telefone" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="58" class="form-control" id="editar-cidade" name="cidade" required>
                        </div>
                        <div class="form-group">
                            <label for="editar-responsavel">Nome do Responsável</label>
                            <input type="text" maxlength="54" class="form-control" id="editar-responsavel" name="responsavel">
                        </div>
                        <div class="form-group">
                            <label for="editar-cpf-responsavel">CPF do Responsável</label>
                            <input type="text" maxlength="14" class="form-control" id="editar-cpf-responsavel" name="cpf_responsavel">
                        </div>
                        <div class="form-group">
                            <label for="editar-carteira-convenio">Carteira do Convênio</label>
                            <input type="text" maxlength="14" class="form-control" id="editar-carteira-convenio" name="carteira_convenio">
                        </div>
                    </div>
